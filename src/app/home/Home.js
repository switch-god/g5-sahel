                ...
                <Col md={10}>
                    ...
                    <Row>
                        <Col xs={12} md={8}>
                            <Link 
                                to={{
                                    pathname : `/solo-page/${actualitesG5[0].slug}`,
                                }}  
                        ...
                        <Col xs={12} md={4}>    
                            ...
                            <Link 
                                to={{
                                    pathname : `/solo-page/${actualitesG5[1].slug}`,
                                }}
                                style={{ textDecoration: 'none' }}>
                            <div className="container-for-img">
                                {
        ...
        return (
            ...
            <div>
                ...
                {/* LATEST NEWS */}
                {
                    ...
                    <Link 
                        to={{
                            pathname : `/solo-page/${posts[0].slug}`,
                        }}  
                        style={{ textDecoration: 'none' }}
                    >
                    <Row>
              ...
              <Row>
                {
                    activites.map((activity,index) => 
                        ...
                        <Col xs={12} md={3} key={index}>
                            <Link 
                                to={{
                                    pathname : `/solo-page/${activity.slug}`,
                                }}  
                                style={{ textDecoration: 'none' }}
                            >
